...
*/
const exclaimTwo1 = str => str.toUpperCase() + '!!!'
console.log("yep one liner works")
...
//CODE HERE
const take = (string) => console.log(string.toUpperCase())
take(sampleString)
...
function emailCheck(email){
  ...
  // email = 
  if(email.includes('@')){
    return 'email verified at: ' + email
  } else{
    return 'must provide a valid email address'
  }
}
v1= emailCheck('hyes@rEAlemail.com')
v2= emailCheck('yikes')
console.log(v1)
console.log(v2)
...
//CODE HERE
function giveMeChocoFrogs(gold){
  let goldFrogs = 0
...
let totalFrogs = giveMeChocoFrogs(4)
