...
//CODE HERE
let manager = new Manager('Hikmah', ['weekday mornings', 'weekday afternoons'], ('Cici','Winny')) 
manager.addEmployee('Cece')
manager.addEmployee('Winston')
